...
class Employee {
    ...
    public void displayEmployeeInfo() {
        ...
        System.out.println("Total Hours per Month: P" + totalHoursPerMonth);
        ...
        System.out.printf("(" +"P" + totalDeductions + " - "+"P" + withHoldingTax + " - " +"P"+ grossPay + ")");
    	System.out.println("\n======================================");
...
public class Group4Practical {
    public static void main(String[] args) {
        ...
        int choice = 0;
        double grossPay = 0;
        boolean checker, rankChecker = false; 
        int rankCounter = 0;
        int counter = 0;
        String rank;
                                ...
                                switch (rank.toUpperCase()) {
                                    case "CEO":
                                        if (grossPay < 70000 || grossPay > 100000) {
                                            System.out.println("--------------------------------------");
                                            System.out.println("Enter an amount in the specific range.");
                                            counter++;
                                        } else {
                                            checker = false; 
                                        }
